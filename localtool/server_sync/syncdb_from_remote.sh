...
ssh root@crowdtutor.info "mongodump --db eduwiki_db --collection wiki_question --out /opt/backup/eduwiki-20150914"
ssh root@crowdtutor.info "mongodump --db eduwiki_db --collection question_set --out /opt/backup/eduwiki-20150914"

ssh root@crowdtutor.info "mongodump --db eduwiki_db --collection wiki_question_answer --out /opt/backup/eduwiki-20150914"
...
mongorestore --db eduwiki_db --collection quiz_answers ./export_results/eduwiki-20150914/eduwiki_db/quiz_answers.bson
