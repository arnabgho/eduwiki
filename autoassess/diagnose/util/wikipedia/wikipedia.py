...
class WikipediaPage(object):
    ...
    def wikitext(self):
        ...
        if not getattr(self, '_wikitext', False):
            ...
            request = _wiki_request(query_params)
            self._wikitext = request['query']['pages'][self.pageid]['revisions'][0]['*']
    ...
    # @property
    # def internal_links(self, limit=3):
    #     '''
    #     List of categories of a page excluding hidden categories
    #     '''
    #
    #     if not getattr(self, '_internal_links', False):
